...
describe PulseMeter::DygraphsVisualize::DSL::Widgets::Pie do
  ...
  describe "#to_data" do
    it "should produce PulseMeter::DygraphsVisualize::Widgets::Pie class" do
      w.to_data.should be_kind_of(PulseMeter::DygraphsVisualize::Widgets::Pie)
    end
  end
